...
<c:url var="insertUrl" value="/nhan-vien-chinh-thuc/chinh-sua"/>
<c:url var="updateUrl" value="/nhan-vien-chinh-thuc/danh-sach"/>
        <style>
            #bang {
			...
			<security:authorize access="isAnonymous()">
				<c:redirect url="/dang-nhap?message=notlogin" />
                    ...
                    <form:form method="POST" id="formSubmit" modelAttribute="model">
                        ...
                        <div>
                            <span>
                                <form:input path="religion" title="Tôn giáo" placeholder="Tôn Giáo"/>
                        ...
                        <div>
                            <span>
                            	<form:input path="email" type="email" title="Địa chỉ email" placeholder="Email"/>
                           		<span>
                                    <form:select path="payrate_id" id="payrate_id">
                                    	<form:option value="" label="-- Chuyên nghành --" />
                                    	<form:options items="${payrateids}" cssStyle="color: #000099" itemValue="id" itemLabel="namepay"/>
                                    </form:select>
                                </span> 
                            </span>
                        </div>
                        <div>
                            <span>
                            	...
                            	<form:input path="experience" title="Kinh nghiệm" placeholder="Kinh nghiệm"/>
                             </span>
                        </div>
                        <div>
                            <span>	
                                	<form:input path="address" title="Địa chỉ thường trú" placeholder="Địa Chỉ Thường Trú"/>
                                	<form:input title="Vị trí" path="location" placeholder="Vị Trí"/>
                             </span>
                        </div>
