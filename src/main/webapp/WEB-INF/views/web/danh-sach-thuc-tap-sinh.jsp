...
<c:url var="SuccessUrl" value="/nhan-vien-thuc-tap/danh-sach"/>	
        <style>
          #bang {
	...
	color: #898989;
        ...
        <c:if test="${not empty message}">
			...
			<security:authorize access="isAnonymous()">
                ...
                <div>
                    <form action="/seachIntern" method="GET">
						<a href="#"><i class="far fa-address-card"> Hồ Sơ Nhân Viên Thực Tập</i></a>
           				<input name="fullname" style="color:white;opacity: 1.7;width:257px;border-radius:14px;background-color: rgba(0, 0, 0, 0);position: relative;padding-left: 38px;" type="text" placeholder="Có không giữ mất thì tìm" />
        		   		<i style="opacity:0.7;line-height: 51px;margin-left: -242px;" class="fas fa-search"></i>
   					</form>
                </div>
                <div class="clearfix"></div>
                <div>
                <form action="<c:url value='/nhan-vien-thuc-tap/danh-sach' />" id="formSubmit" method="get">
                    <table id="bang">
                        <tr>
                            	<th>STT</th>
                                <th>Họ Và Tên</th>
                      ...
                      <c:if test="${not empty model.listResult}">
                        ...
                        <tr>
							...
							<td>
								<span style="font-size: 18px;">
									<a href="<c:url value='/nhan-vien-thuc-tap/chinh-sua?id=${item.id}' />">
                        ...
                        <c:if test="${empty model.listResult}">
							<tr>
								<td colspan="15">Danh Sách Nhân Viên Trống !</td>
							</tr>
						</c:if>
                    </table>
